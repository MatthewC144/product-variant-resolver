...
Decision progress is now 1/5. The first verbatim owner answer is stored in a private append-only,
packet-bound ledger and normalized to `same_review_family`; four questions remain pending. The public
