...
Decision progress is now 2/5. The first two verbatim owner answers are stored in a private append-only,
packet-bound ledger and both normalize to `same_review_family`; three questions remain pending. The
