...
> Date: 2026-09-01  
> Last focused update: 2026-09-08 (T36 priority-2 batch-01 owner decisions)
> QA mode: `.codex/agents/qa.toml` MVP Mode  
> Scope: `specs/product-variant-resolver/mvp-brief.md` R1–R27
...
T30–T36 external-data intake/pre-review/queue/evidence/research/decision milestones are QA-closed
for their stated Lite scope. The next highest-value step is source research for the next ten of the
39 pending priority-2 families, using the T36 cumulative queue as the input so completed families
cannot be selected again. Only after all 49 have attributable outcomes should the project
